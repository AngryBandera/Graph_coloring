...
5. Записування інформації про граф у файл - **write\_file(graph, colored\_graph, output\_file)**
...
6. Тестування програми на різних графах - **generate\_graph(num\_nodes, density)**
...
7. Результат чи успішне розфарбування + нові кольори вершин - **create\_colored\_graph(graph)**
