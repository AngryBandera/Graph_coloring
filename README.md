...
1. Зчитування графу з файлу - функція **read\_file(filepath)**
   ...
   ***Як працює:***
   ...
   1. Зчитує рядки файлу та інтерпретує інформацію.
   1. Зберігає граф у вигляді списку списків, де кожна вершина має свій список сусідніх (зв’язків).
...
1. Перетворення КНФ в імплікаційний граф - **create\_implication\_graph(cnf, vertexes\_count)**
...
1. Алгоритм 2-SAT, який включає в себе алгоритм Тар’яна для пошуку сильнозв’язнизних компонент та визначення чи існує розв’язок КНФ + присвоєння атомам True або False - **find\_solution(implication\_grap)**
...
1. Використовує спеціальний алгоритм (алгоритм Тар’яна) для пошуку сильнозв’язних компонентів.

1. Перетворення розв’яку 2-SAT в кольори - **color\_graph(cnf\_solution)**
   ...
   ***Як працює:***
   ...
   1. Якщо рішення немає, повертає відповідне повідомлення.

1. Записування інформації про граф у файл - **write\_file(graph, colored\_graph, output\_file)**
   ...
   ***Як працює:***
   ...
   1. Якщо файл не задано, повертає цей опис у вигляді тексту.

1. Тестування програми на різних графах - **generate\_graph(num\_nodes, density)**
   ...
   ***Як працює:***
   ...
   1. Додає випадкові зв’язки між вершинами на основі щільності.

1. Результат чи успішне розфарбування + нові кольори вершин - **create\_colored\_graph(graph)**
