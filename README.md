...
6. Перетворення розв’яку 2-SAT в кольори - **color\_graph(cnf\_solution)**
...
7. Записування інформації про граф у файл - **write\_file(graph, colored\_graph, output\_file)**
...
8. Тестування програми на різних графах - **generate\_graph(num\_nodes, density)**
...
9. Результат чи успішне розфарбування + нові кольори вершин - **create\_colored\_graph(graph)**
